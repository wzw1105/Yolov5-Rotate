...
def non_max_suppression(
    ...
    nc = prediction.shape[2] - nm - 6  # number of classes #添加角度 5 -> 6
    ...
    #print("muti_label ", multi_label)
    merge = False  # use merge-NMS

    t = time.time()
    mi = 5 + nc  # mask start index # 添加角度 5 -> 6
    output = [torch.zeros((0, 7 + nm), device=prediction.device)] * bs #添加角度 6 -> 7
